...
document.querySelector(".header__buttons").addEventListener("click", (e)=>{
    ...
    e.target.closest(".header__navBut[favBut]") !== null && (document.querySelector(".header__navBut[homeBut]").classList.remove("activeBut"), document.querySelector(".header__navBut[favBut]").classList.add("activeBut"), document.querySelectorAll(".container.homePage").forEach((cont)=>cont.style.display = "none"), document.querySelectorAll(".container.favPage").forEach((cont)=>cont.style.display = "block"), document.querySelector(".footer").style.display = "none");
});

},{}],"eHVZK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getEx", ()=>getEx);
var _axios = require("axios");
...
document.querySelector(".favorites").addEventListener("click", (e)=>{
    e.target.closest(".favorites__delBut") !== null && (localStorage.setItem("fav", JSON.stringify(JSON.parse(localStorage.getItem("fav").replace(e.target.closest(".favorites__delBut").dataset.id, "")).filter((fav)=>fav !== "" && fav !== undefined))), showFavs());
});

},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["farZc","8lqZg"], "8lqZg", "parcelRequirec6f1")
